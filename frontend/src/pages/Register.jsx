    ...
    <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-br from-[#030711] via-[#0A1A2F] to-[#04131C] text-white">
      ...
      >
        ...
        <p className="text-gray-400 text-center mb-6 text-sm">
          Register to access your secure fraud detection system
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full p-2.5 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 transition-all"
              required
            />
          </motion.div>
